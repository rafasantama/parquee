...
@Component({
  selector: 'app-historias-left-sidebar',
  templateUrl: './historias-left-sidebar.component.html',
  styleUrls: ['./historias-left-sidebar.component.scss'],
...
export class HistoriasLeftSidebarComponent implements OnInit {
