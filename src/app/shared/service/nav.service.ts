...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
	 {
			title: 'Parque E', type: 'sub', children: [
            { path: '/somos', title: 'Somos', type: 'link' },
				{ path: '/historia', title: 'Historia', type: 'link' },
            { path: '/equipo', title: 'Equipo de Trabajo', type: 'link', },
            // { path: '/event', title: 'Redes de Trabajo', type: 'link' },
    ...
    {
      title: 'Emprendedores', type: 'sub', children: [
         { path: '/registrate', title: 'Registrate', type: 'link' },
         { path: '/historias', title: 'Banco de Emrpendedores', type: 'link' },
      ],
 },
 { path: '/herramientas', title: 'Herramientas y Oportunidades',  type: 'link' },
   //  {
	// 		title: 'Herramientas y Oportunidades', type: 'sub', children: [
   ...
   //             { path: '/herramientas', title: 'Noticias',  type: 'link' },
   //             { path: '/herramientas', title: 'Banco de Oportunidades',  type: 'link' },
   //             { path: '/herramientas', title: 'Capsulas de Conocimiento',  type: 'link' },
